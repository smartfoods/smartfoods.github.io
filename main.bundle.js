    ...
    },
    {
        ...
        children: [
            ...
            ,
            {
              ...
              loadChildren: './pages/relatorio/relatorio-routing.module#RelatorioRoutingModule'
            }
      */
        ]
    },
...
var AdicionalProdutoService = (function (_super) {
    ...
    AdicionalProdutoService.prototype.findByCategoria = function (idCategoria) {
        ...
        return this.http.get(this.url + "/categoria/" + idCategoria, this.getHearderToken());
    };
...
var CepModalComponent = (function (_super) {
    ...
    CepModalComponent.prototype.consultarCEP = function (nrCep) {
        ...
        this.consultaCEPService.consultarCEP(nrCep)
            .subscribe(function (res) {
            _this.alterarFormCep(res);
            trata_error_service_1.TrataErrorService.limparMensagemError();
        }, function (error) { return trata_error_service_1.TrataErrorService.emitirMensagemError("O CEP informado não foi localizado"); });
    };
    CepModalComponent.prototype.btnConfirmar = function (value) {
        ...
        if (value.emAlteracao) {
            ...
            this.item.idPessoa = value.idPessoa;
            this.item.idLogradouro = value.idLogradouro;
            this.item.dsEndereco = value.dsEndereco;
            this.item.nrCep = value.nrCep;
            this.item.dsReferencia = value.dsReferencia;
            this.item.nmLogradouro = value.nmLogradouro;
            this.item.nrComplemento = value.nrComplemento;
            this.item.txComplemento = value.txComplemento;
            this.item.nmBairro = value.nmBairro;
            this.item.nmMunicipio = value.nmMunicipio;
            this.item.uf = value.uf;
            */
    ...
    CepModalComponent.prototype.criarForm = function () {
        this.formulario = this.fb.group({
            ...
            dsReferencia: [''],
            nmLogradouro: [''],
            nrComplemento: ['', forms_1.Validators.required],
            txComplemento: [''],
            nmBairro: [''],
    ...
    CepModalComponent.prototype.alterarFormCep = function (endereco) {
        this.formulario.patchValue({
            idLogradouro: endereco.idLogradouro,
            nmBairro: endereco.nmBairro,
            nmLogradouro: endereco.nmLogradouro,
            nmMunicipio: endereco.nmMunicipio,
            uf: endereco.uf,
        });
    };
    CepModalComponent.prototype.alterarForm = function (endereco) {
        ...
        this.formulario.patchValue({
            ...
            dsReferencia: endereco.dsEndereco,
            nmLogradouro: endereco.nmLogradouro,
            nrComplemento: endereco.nrComplemento,
            txComplemento: endereco.txComplemento,
            nmBairro: endereco.nmBairro,
...
var PesquisarClienteModalComponent = (function (_super) {
    ...
    PesquisarClienteModalComponent.prototype.selecionarCliente = function (cliente) {
        ...
        this.cliente.nmPessoa = cliente.nmPessoa;
...
var PesquisarProdutoModalComponent = (function (_super) {
    ...
    PesquisarProdutoModalComponent.prototype.selecionarProduto = function (produto) {
        ...
        if (this.ocultarAcompanhamento) {
            ...
            this.adicionalProduto.findByCategoria(produto.idCategoria)
                .subscribe(function (res) {
                for (var _i = 0, res_1 = res; _i < res_1.length; _i++) {
                    var p = res_1[_i];
                    var prod_1 = {};
                    prod_1.id = p.idProduto;
                    prod_1.nmProduto = p.nmProduto;
                    _this.adicionais.push(prod_1);
                }
            }, function (error) { return trata_error_service_1.TrataErrorService.tratarError(error); });
            this.ctrExibicaoCampoOrdem = this.exibirCampoOrdem;
        }
...
var AbstractService = (function () {
    ...
    AbstractService.prototype.getPDF = function () {
        // return { responseType: 'blob' };
        var authHeader = {
            responseType: 'blob',
            headers: new http_1.HttpHeaders({ 'Authorization': 'Bearer ' + this.getToken().token })
        };
        return authHeader;
    };
...
exports.API_CONFIG = {
    ...
    baseUrl: "http://paladar.us-west-2.elasticbeanstalk.com",
    ...
    ConsultaCEPService.prototype.consultarCEP = function (nrCep) {
        ...
        if (nrCep != "") {
            ...
            if (validaCep.test(nrCep)) {
                return this.http.get(api_config_1.API_CONFIG.baseUrl + "/logradouro/cep/" + nrCep);
            }
        }
    };
