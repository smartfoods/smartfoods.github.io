...
var CardapioService = (function (_super) {
    ...
    CardapioService.prototype.findAllByCardapio = function (idCardapio) {
...
var CreateCardapioComponent = (function (_super) {
    ...
    function CreateCardapioComponent(fb, location, cardapioService, router) {
        var _this = _super.call(this) || this;
        _this.fb = fb;
    ...
    CreateCardapioComponent.prototype.ngOnInit = function () {
        ...
        //this.carregarItemCardapio(this.cardapio.id);
    };
    CreateCardapioComponent.prototype.confirmar = function (value) {
        var _this = this;
    ...
    CreateCardapioComponent.prototype.criarFormulario = function () {
    ...
    CreateCardapioComponent.prototype.alterarForm = function (cardapio) {
    ...
    CreateCardapioComponent.prototype.voltar = function () {
        this.location.back();
    };
    CreateCardapioComponent.prototype.excluirItemCardapio = function () {
        var _this = this;
    ...
    CreateCardapioComponent.prototype.selecionarItem = function (item) {
        this.cardapioItem = item;
        this.popupExclusaoItem.show();
    };
    CreateCardapioComponent.prototype.adicionarItemCardapio = function (value) {
        var _this = this;
        var item = {};
    ...
    CreateCardapioComponent.prototype.carregarItemCardapio = function (idCardapio) {
        var _this = this;
        console.log(idCardapio);
        if (idCardapio != null) {
            this.cardapioService.findAllByCardapio(idCardapio).subscribe(function (res) { return _this.cardapioItens = res; }, function (error) { return trata_error_service_1.TrataErrorService.tratarError(error); });
        }
    };
...
], CreateCardapioComponent.prototype, "popupExclusaoItem", void 0);
...
var UpdateCardapioComponent = (function (_super) {
    ...
    function UpdateCardapioComponent(fb, route, location, cardapioService, router) {
        var _this = _super.call(this) || this;
        _this.fb = fb;
        _this.route = route;
        _this.location = location;
    ...
    UpdateCardapioComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            _this.cardapioService.findById(id).subscribe(function (resp) {
                var cardapio = resp;
                _this.alterarForm(cardapio);
            }, function (error) { return trata_error_service_1.TrataErrorService.tratarError(error); });
        });
    };
    UpdateCardapioComponent.prototype.confirmar = function (value) {
        var _this = this;
        this.cardapioService.salvar(value)
            .subscribe(function (response) {
            if (response['body'] != null) {
    ...
    UpdateCardapioComponent.prototype.criarFormulario = function () {
        this.formulario = this.fb.group({
            id: [],
            nmCardapio: ['', [forms_1.Validators.required, forms_1.Validators.minLength(3), forms_1.Validators.maxLength(40)]],
            dsComentario: [''],
    ...
    UpdateCardapioComponent.prototype.alterarForm = function (cardapio) {
        this.formulario.patchValue({
            id: cardapio.id,
            nmCardapio: cardapio.nmCardapio,
            dsComentario: cardapio.dsComentario,
    ...
    UpdateCardapioComponent.prototype.voltar = function () {
        this.location.back();
    };
    UpdateCardapioComponent.prototype.excluirItemCardapio = function () {
        var _this = this;
        this.cardapioService.excluirItem(this.cardapioItem)
            .subscribe(function (res) {
            event_emitter_services_1.EventEmitterService.emitirMensagemToasterSucesso('Cardapio', 'O item do cardapio foi excluído com sucesso!!!');
    ...
    UpdateCardapioComponent.prototype.selecionarItem = function (item) {
        this.cardapioItem = item;
        this.popupExclusaoItem.show();
    };
    UpdateCardapioComponent.prototype.adicionarItemCardapio = function (value) {
        var _this = this;
        var item = {};
        item.cardapio = this.cardapio;
        item.produto = value.produto;
    ...
    UpdateCardapioComponent.prototype.carregarItemCardapio = function (idCardapio) {
        var _this = this;
        console.log(idCardapio);
        if (idCardapio != null) {
            this.cardapioService.findAllByCardapio(idCardapio).subscribe(function (res) { return _this.cardapioItens = res; }, function (error) { return trata_error_service_1.TrataErrorService.tratarError(error); });
...
__decorate([
    core_1.ViewChild('modalExcluirItemCardapio'),
    __metadata("design:type", Object)
], UpdateCardapioComponent.prototype, "popupExclusaoItem", void 0);
