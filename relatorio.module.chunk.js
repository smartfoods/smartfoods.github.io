...
var RelatorioPedidoComponent = (function (_super) {
    ...
    RelatorioPedidoComponent.prototype.gerarPDF = function (pedido) {
        var _this = this;
        this.relatorioService.gerarPdf(pedido.id)
    ...
    RelatorioPedidoComponent.prototype.gerarEtiquetaPDF = function (pedido) {
        var _this = this;
        this.relatorioService.gerarEtiquetaPdf(pedido.id)
            .subscribe(function (data) { return _this.openWindows(data); }, function (error) { return trata_error_service_1.TrataErrorService.tratarError(error); });
    };
...
var RelatorioService = (function (_super) {
    ...
    RelatorioService.prototype.gerarPdf = function (idPedido) {
        return this.http.get(this.urlReportPedido + "/" + idPedido + "/pdf", this.getPDF())
            .map(function (res) {
            return new Blob([res], { type: 'application/pdf' });
        });
    };
    RelatorioService.prototype.gerarEtiquetaPdf = function (idPedido) {
        return this.http.get(this.urlReportPedido + "/" + idPedido + "/etiqueta", this.getPDF())
            .map(function (res) {
            return new Blob([res], { type: 'application/pdf' });
        });
    };
